...
export default function MainPageClient() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start">
            <div className="min-w-0 flex-1">
              <div className="w-full overflow-hidden border border-slate-300 bg-slate-100">
                <img src="/imagebanner.jpg" alt="imagebanner" className="h-[150px] w-full object-cover sm:h-[180px]" loading="lazy" />
              </div>
            </div>
      ...
      {/* ✅ 메인에서는 공지만 */}
      <div className="mb-2 text-[13px] font-semibold text-slate-800">공지</div>
